...
create table tb_movie (id  bigserial not null, img_uri varchar(255), sub_title varchar(255), synopsis TEXT, title varchar(255), year int4, genre_id int8, primary key (id));
create table tb_review (id  bigserial not null, text TEXT, movie_id int8, user_id int8, primary key (id));
...
alter table tb_review add constraint FKlsf32ta36ogeqnxw11rmxhiyf foreign key (id) references tb_review;
